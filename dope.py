...
#imgs = np.reshape(imgs,(114,176,3,3))
    ...
    while (True):
        ...
        #print("temp:",temp_out_strong.shape,temp_out_strong,"imgs:",imgs.shape,imgs[:,:,:,0])
        #print("we:",np.asarray(normalizeImage(wea).shape))
